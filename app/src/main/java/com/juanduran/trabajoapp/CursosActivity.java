...
public class CursosActivity extends AppCompatActivity {
    ...
    private void configureNextButton() {
        ...
        nexButtonJ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CursosActivity.this, contenidoCursos.class));
            }
        });
    ...
    private void configureNextButtonMenu(){
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CursosActivity.this,MenuActivity0.class));
            }
        });
        ...
        nextButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CursosActivity.this,CursosActivity.class));
            }
        });
